...
export const PullToRefresh = ({ onRefresh, isRefreshing, children }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="bg-white dark:bg-gray-800 shadow-lg dark:shadow-gray-900/50 rounded-full p-3 flex items-center space-x-2">
          <RefreshCw
            className={`w-5 h-5 text-emerald-600 dark:text-emerald-400 ${isRefreshing || isTriggered ? 'animate-spin' : ''
              }`}
          />
