  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="relative inline-block w-full max-w-6xl my-8 text-left align-middle bg-white dark:bg-gray-800 shadow-xl rounded-2xl transform transition-all">
          {/* Header */}
          <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
            <div className="flex-1 mr-4">
              ...
              <div className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                <span className="text-emerald-600 dark:text-emerald-400 font-medium">{article.source}</span>
          ...
          <div className="flex items-center justify-between px-6 py-4 bg-gray-50 dark:bg-gray-900/50 border-b border-gray-200 dark:border-gray-700">
            <div className="flex items-center space-x-2">
              <button
                ...
                className={`px-4 py-2 rounded-lg font-medium transition-all duration-200 ${view === 'original'
              ...
              {currentSimplified && (
                <>
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg font-medium transition-all duration-200 ${view === 'simplified'
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg font-medium transition-all duration-200 ${view === 'split'
          ...
          <div className="max-h-[70vh] overflow-y-auto">
            ...
            <div className="p-6">
              ...
              {view === 'simplified' && currentSimplified && (
                <div className="prose prose-lg max-w-none dark:prose-invert">
                  <div className="bg-blue-50 dark:bg-blue-900/10 border border-blue-200 dark:border-blue-700/30 rounded-lg p-4 mb-6">
                    <div className="flex items-center space-x-2 mb-2">
                      <Sparkles className="w-5 h-5 text-blue-600 dark:text-blue-400" />
                      <span className="font-medium text-blue-800 dark:text-blue-300">AI Simplified Version</span>
                    </div>
